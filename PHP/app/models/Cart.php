...
(
    ...
    [sum] => SUM - общая стоимость товара
*/
...
class Cart extends AppModel {
    ...
    public function addToCart($product, $qty = 1, $mod = null){
        ...
        // Если есть модификатор, добавляем его, иначе добавляем просто товар
        if($mod){
        ...
        // Если есть сумма и количество, прибавляем к ним еще добавленный товар
    ...
    // Удалить из корзины товар для CartController action
    ...
    // Пересчет валют в правильную, в корзине
