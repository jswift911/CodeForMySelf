...
<?php
$contact = get_page_by_title('Contact'); // Также можно получить страницу по id
if ($contact) :
// 1 вариант
                ...
                <div class="container">
                    <div class="row ">
                        <div class="col-md-6 contact-container">
                            <?php if (get_field('contact_header', $contact)):; //если поля ищем в рубрике, то после запятой прописываем переменную с рубрикой?>
                                <h2 class="title-section"><span class="title-regular"><?php the_field('contact_span', $contact) ;?></span><br/><?php the_field('contact_header', $contact) ;?></h2>
                            <?php endif;?>
                            <hr class="title-underline" />
                            <p>
                                <?php the_field('contact_description', $contact);?>
                            </p>
